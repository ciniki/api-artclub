...
//	</users>
//
function ciniki_artclub_fileHistory($ciniki) {
	//
	...
	$rc = ciniki_artclub_checkAccess($ciniki, $args['business_id'], 'ciniki.artclub.fileHistory', 0);
	if( $rc['stat'] != 'ok' ) {
		return $rc;
	}
	...
	return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.artclub', 
		'ciniki_artclub_history', $args['business_id'], 
		'ciniki_artclub_files', $args['file_id'], $args['field']);
}
?>
